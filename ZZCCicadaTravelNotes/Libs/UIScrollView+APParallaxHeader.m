...
- (void)addParallaxWithImage:(UIImage *)image andHeight:(CGFloat)height andShadow:(BOOL)shadow {
    ...
    {
        //初始化 滚动视差View
        APParallaxView *parallaxView = [[APParallaxView alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width*1, height) andShadow:shadow];
...
//        UIImageView *SurbaseView = [[UIImageView alloc]initWithFrame:CGRectMake(10, 90, 300, 5)];
//        [SurbaseView setImage:[UIImage imageNamed:@"ArticleCoverSurbase"]];
//        [parallaxView addSubview:SurbaseView];
